    ...
    return (
        ...
        >
            <div className="max-w-2xl mx-auto flex align-top space-x-4">
                ...
                {message.role === "user" ? (
                    <div className="py-1 flex-grow leading-[1.5rem] md:pe-8 text-sm text-slate-300 whitespace-pre-line break-words space-y-0">
                        {message.content}
                    </div>
                ) : (
                    <ReactMarkdown
                        ...
                        className="markdown py-1 flex-grow leading-[1.7rem] md:pe-8 text-sm text-slate-300 whitespace-pre-line break-words"
                    >
                        {message.content || ""}
                    </ReactMarkdown>
                )}
